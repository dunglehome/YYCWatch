...
class ElectionController {
    ...
    public static function getReturnPages($year, $filename) {
        ...
        while (($file = readdir($d)) !== false) {
            ...
            if (file_exists("$dir/$file.rotated")) {
                continue;
            }
            $pages[] = "$dir/$file";
        }
    ...
    public static function showRace($race) {
        ...
        top($title);
        print "<h1>$title <small><a href=\"/YYCWatch/www/election\">main election page</a></small></h1>\n";
    ...
    public static function showMain() {
        ...
        foreach ($wards as $ward) {
            ...
            if ($mod == 0) {
                ...
                ?>
                <div class="span3">
                    <h4><a href="<?php print $raceLink; ?>"><?php
                            print "{$wardInfo['ward']}";
                            if (count($rows) > 0) {
                                print ' (' . count($rows) . ')';
                            }
      ...
      where published = 1 and e.id = :id ", array('id' => $id));
        ...
        public static function questionList() {
            ...
            <h1>Election Questions
                <small><a href="/YYCWatch/www/election">main election page</a></small>
            </h1>
            <p class="lead">
