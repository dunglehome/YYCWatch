...
class UserController {
    ...
    static public function emailSendVerify() {
        ...
        $mail->Body = "
    To complete your email address verification with YYCWatch click on the link below.<br/><br/>
    <a href=\"$url\">$url</a><br/><br/>
    Ignore this email if you did not request an account on OttWatch.ca
    ";
        $mail->AltBody = "
    To complete your email address verification with YYCWatch click on the link below.
    ...
    static public function home() {
        ...
        $name = getSession()->get('user_name');
        if ($name == '' || $name == null) {
            $name = 'Your Name';
        }
        $email = getSession()->get('user_email');
        if ($email == '' || $email == null) {
            $email = 'Your Email';
        }
        ?>
