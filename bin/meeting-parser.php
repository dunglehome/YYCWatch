...
$data = `wget -qO - http://agendaminutes.calgary.ca/sirepub/rss/rss.aspx | head -1`; # file_put_contents("rss.rss",$data);
...
foreach ($items as $i) {
    ...
    if ($mdb['id']) {
      ...
      where
        ...
        print "$category ($meetid) is new\n" . OttWatchConfig::WWW . "/meetingys/meeting/{$meetid}\n";
