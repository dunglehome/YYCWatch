...
function dashboard() {
    global $OTT_WWW;
    top("YYCWatch - watching calgary.ca to save you time");
    ?>
    <div class="row-fluid">
        <div class="span4">

            <p class="lead">
                <b>YYCWatch</b> is dedicated to making it easier to be
                part of the political conversation in Calgary.
                <a href="about">Read about all the features</a>.

            <div style="background: green; color: #ffffff; padding: 20px; font-size: 200%; border-radius: 4px;">
                <center>
                    <a href="/YYCWatch/www/election" style="color: #ffffff;">
            ...
            <div style="margin-top: 10px; background: green; color: #ffffff; padding: 20px; font-size: 200%; border-radius: 4px;">
                <center>
                    <a href="/YYCWatch/www/election/listDonations" style="color: #ffffff;">
            ...
            <div style="margin-top: 10px; background: green; color: #ffffff; padding: 20px; font-size: 125%; border-radius: 4px;">
                <center>
                    <?php
                    $row = getDatabase()->one(" select * from story where deleted = 0 and published = 1 order by updated desc limit 1 ");
                    $row['body'] = '';
                    print "<a style=\"color: #ffffff;\" href=\"/YYCWatch/www/story/{$row['id']}\">";
            ...
            <table class="table table-bordered table-hover table-condensed" style="width: 100%; margin-top: 20px;">
                ...
                if (count($meetings) > 0) {
                    ...
                    foreach ($meetings as $m) {
                        $mtgurl = htmlspecialchars("http://agendaminutes.calgary.ca/sirepub/mtgviewer.aspx?meetid={$m['meetid']}&doctype");
                        ?>
                        <tr>
    ...
    order by starttime ");
        ...
        <div class="span4">
            ...
            <ul>
                ...
                <li><a href="<?php print $OTT_WWW; ?>/opendata/">OpenData</a>: Most recently updated data from <i>data.calgary.ca</i>.</li>
            ...
            <ul>
                ...
                if (!LoginController::isLoggedIn()) {
                    ?>
                    <li><a href="<?php print $OTT_WWW; ?>/user/login">Login</a>: Log in to YYCWatch for user-specific features</li>
                    <?php
                } else {
                    ?>
                    ...
                    <div class="navbar">
                        <div class="navbar-inner">
                            <ul class="nav">
                                ...
                                ?>
                                <a href="<?php print $OTT_WWW; ?>"><img style="float: right; padding: 9px; width: 45px; height: 20px;" src="<?php print $OTT_WWW; ?>/img/yyc.jpg"/></a>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        function bottom($quiet = false) {
            ...
            if (!$quiet) {
                ...
                <div class="well" style="margin-top: 10px;" >
                    ...
                    <a href="<?php print $OTT_WWW; ?>"><img style="float: right; padding-left: 5px; width: 50px; height: 50px;" src="<?php print $OTT_WWW; ?>/img/yycwatch.jpg"/></a>
                    <i>Created by <a href="http://library.ucalgary.ca"><b>lcrit tfdl</b></a> to make it easier to be part of the political conversation in Calgary.</i><br/>
                    On Twitter? Follow <b><a href="http://twitter.com/yycwatch">@yycwatch</a></b> and <b><a href="http://twitter.com/ppival">@ppival</a></b>
            ...
            <script type="text/javascript">
                ...
                var disqus_shortname = 'yycwatch'; // required: replace example with your forum shortname
